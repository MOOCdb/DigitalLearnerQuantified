...
featureDict = {
     1:  {'name': "dropout",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Whether or not the student has dropped out by this week
         (this is the label used in prediction).
         '''},
     ...
     7:  {'name': "number_of_attempts",
         ...
         'default': 0,
         'dependencies':[209],
         'desc': ''' Number of potentially non-distinct problem attempts during
         the week.'''},
     ...
     10: {'name': "sum_observed_events_duration_per_correct_problem",
         ...
         'default': -1,
         'dependencies':[110],
         'desc': ''' Total time spent on all resources during the week (feat.
         2) divided by number of correct problems (feat. 8).'''},
     11: {'name': "number_problem_attempted_per_correct_problem",
         ...
         'default': -1,
         'dependencies':[111],
         'desc': ''' Number of problems attempted (feat. 6) divided by number
         of correct problems (feat. 8).'''},
     12: {'name': "average_time_to_solve_problem",
         'filename': 'populate_feature_12_average_time_to_solve_problem',
         'extension': '.sql',
         'default': -1,
         'dependencies':[112],
         'desc': ''' Average of (max(attempt.timestamp) -
         min(attempt.timestamp)) for each problem during the week.'''},
     13: {'name': "observed_event_timestamp_variance",
         'filename': 'populate_feature_13_observed_event_timestamp_variance',
         'extension':  '.py',
         'default': 0,
         'dependencies':[],
         'desc': '''Variance of a students observed event timestamps in one
         week. '''},
     ...
     16: {'name': "sum_observed_events_lecture",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Total time spent on all lecture-related resources during
         the week.'''},
     17: {'name': "sum_observed_events_book",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Total time spent on all book-related resources during the
         week.'''},
     18: {'name': "sum_observed_events_wiki",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Total time spent on all wiki-related resources during the
         week.'''},
     103:{'name': "difference_feature_3",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Number of forum posts in current week divided by number of
         forum posts in previous week (difference of feature 3).'''},
     104:{'name': "difference_feature_4",
         'filename': 'populate_feature_104_difference_feature_4',
         'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': ''' Number of wiki edits in current week divided by number of
         wiki edits in previous week (difference of feature 4).'''},
     105:{'name': "difference_feature_5",
         'filename': 'populate_feature_105_difference_feature_5',
         'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': ''' Average length of forum posts in current week divided by
         average length of forum posts in previous week, where number of forum
         posts in previous week is > 5 (difference of feature 5).'''},
     109:{'name': "difference_feature_9",
         'filename': 'populate_feature_109_difference_feature_9',
         'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': ''' Average number of attempts in current week divided by
         average number of attempts in previous week (difference of feature 9).'''},
     110:{'name': "difference_feature_10",
         'filename': 'populate_feature_110_difference_feature_10',
         'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': ''' (Total time spent on all resources during current week
         (feat. 2) divided by number of correct problems during current week
         (feat. 8)) divided by same thing from previous week (difference of
                 feature 10).'''},
     111:{'name': "difference_feature_11",
         ...
         'dependencies':[],
         'desc': ''' (Number of problems attempted (feat. 6) divided by number
         of correct problems (feat. 8)) divided by same thing from previous
     week (difference of feature 11).'''},
     112:{'name': "difference_feature_12",
         ...
         'dependencies':[],
         'desc': ''' (Average of (max(attempt.timestamp) -
         min(attempt.timestamp)) for each problem during current week) divided
     by same thing from previous week (difference of feature 12).'''},
     ...
     202:{'name': "percentile_of_average_number_of_attempts",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Each students average number of attempts during the week
         (feat. 9) compared with other students as a percentile.'''},
     203:{'name': "percent_of_average_number_of_attempts",
         ...
         'dependencies':[],
         'desc': ''' Each students average number of attempts during the week
         (feat. 9) compared with other students as a percent of max.'''},
     204:{'name': "pset_grade",
             'filename': 'populate_feature_204_pset_grade',
             'extension': '.sql',
         'default': 0,
         'dependencies':[205],
         'desc': ''' Number of homework problems correct in a week divided by
         number of homework problems in the week.'''},
     205:{'name': "pset_grade_over_time",
             'filename': 'populate_feature_205_pset_grade_over_time',
             'extension': '.sql',
         'default': -1,
         'dependencies':[],
         'desc': ''' Pset grade from current week (feature 204) - avg(pset
         grade from previous week).'''},
     206:{'name': "lab_grade",
             'filename': 'populate_feature_206_lab_grade',
             'extension': '.sql',
         'default': 0,
         'dependencies':[207],
         'desc': ''' Number of lab problems correct in a week divided by number
         of lab problems in the week.'''},
     207:{'name': "lab_grade_over_time",
             'filename': 'populate_feature_207_lab_grade_over_time',
             'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': ''' Lab grade from current week (feature 206) - avg(lab grade
         from previous week).'''},
     208:{'name': "attempts_correct",
         ...
         'default': -1,
         'dependencies':[209],
         'desc': ''' Number of attempts (any type) that were correct during the
         week.'''},
     209:{'name': "percent_correct_submissions",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Percentage of total submissions that were correct (feature
         208 / feature 7).'''},
     210:{'name': "average_predeadline_submission_time",
         ...
         'default': -1,
         'dependencies':[],
         'desc': ''' Average time between problem submissions and problem due
         date (in seconds).'''},
     301:{'name': "std_hours_working",
         ...
         'default': 0,
         'dependencies':[],
         'desc': ''' Standard deviation of the hours the user produces events
         and collaborations. Tries to capture how regular a student is with her
         schedule while doing a MOOC.'''},
     302:{'name': "time_to_react",
             'filename': 'populate_feature_302_time_to_react',
             'extension': '.sql',
         'default': 0,
         'dependencies':[],
         'desc': ''' Average time in days a student takes to react when a new
         resource in posted. Tried to capture how fast a student is reacting to
         new content.'''},
}
